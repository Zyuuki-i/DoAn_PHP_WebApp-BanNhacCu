<nav aria-label="breadcrumb">
    <ol class="breadcrumb bg-light p-3 rounded-3">
        ...
        <li class="breadcrumb-item">
            <a href="/SanPham" class="text-secondary"><i class="bi bi-house"></i></a>
        </li>
    </ol>
</nav>
<div class="row g-4">
        ...
        ?>
            <div class="col-md-4 mb-4 ho-item">
                <div class="card h-100">
                    <div class="col h-100">
                        <div class="card">
                            <a href="/SanPham/ChiTiet?id=<?php echo htmlspecialchars($item->ma_sp); ?>">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex w-100 justify-content-end">
                                    <form action="/DonDatHang/MuaNgay?id=<?php echo htmlspecialchars($item->ma_sp); ?>" method="post" class="flex-fill">
