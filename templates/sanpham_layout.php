                ...
                <ul class="nav nav-pills flex-column mb-4">
                    <?php foreach ($DsLoai as $loai): ?>
                        <li class="nav-item li-hover">
                            <a class="nav-link text-white" href="/SanPham/LocLoai?maloai=<?= htmlspecialchars($loai->ma_loai) ?>">
            ...
            <?php if (isset($DsNSX) && $DsNSX != null): ?>
                <ul class="nav nav-pills flex-column mb-4">
                    <?php foreach ($DsNSX as $nsx): ?>
                        <li class="nav-item li-hover">
                            <a class="nav-link text-white" href="/SanPham/LocNSX?mansx=<?= htmlspecialchars($nsx->ma_nsx) ?>">
